...
extern uint8_t ecdsaSign(BigNum256 r, BigNum256 s, const BigNum256 hash, const BigNum256 privatekey);
extern uint8_t ecdsaSerialise(uint8_t *out, const PointAffine *point, const bool do_compress);
extern PointAffine privateKeyToPublicKey(BigNum256 private_key);
